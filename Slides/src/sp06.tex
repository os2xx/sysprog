...
Sendirian Berhad\\
\medskip
\url{https://sp.vlsm.org/Slides/sp06.pdf}
...
\section{Project FUSE 3}
\begin{frame}[fragile]
\frametitle{Project FUSE 3}
\begin{itemize}
\item File System
\begin{itemize}
\item \texttt{\$(whoami)@\$(hostname) \$(date '+\%y\%m\%d-\%H\%M\%S')}
\item \texttt{fdisk -l | grep '\^{}Disk'}
\item \texttt{blkid}
\item \texttt{losetup --show --find}
\item \texttt{mount}
\end{itemize}
\end{itemize}
\end{frame}
